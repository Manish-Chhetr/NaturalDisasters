...
public class pastHourFrag extends Fragment implements OnMapReadyCallback {
    ...
    String urlData = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_hour.csv";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_past_hour, container, false);
        return mView;
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        new previousHour().execute();
    }

    public class previousHour extends AsyncTask<String, Void, String> {
