...
public class pastWeekFrag extends Fragment implements OnMapReadyCallback {
    ...
    String urlData = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.csv";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_past_week, container, false);
        return mView;
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        mMapView = mView.findViewById(R.id.map3);
        if (mMapView != null) {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        new previousWeek().execute();
    }

    public class previousWeek extends AsyncTask<String, Void, String> {
